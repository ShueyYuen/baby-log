...
export const weightBoys: PercentileData[] = [
...
export const weightGirls: PercentileData[] = [
...
export const heightBoys: PercentileData[] = [
  ...
  { month: 10, p3: 68.7, p15: 70.6, p50: 73.3, p85: 75.6, p97: 77.9 },
  { month: 11, p3: 69.9, p15: 71.8, p50: 74.5, p85: 76.9, p97: 79.2 },
  { month: 12, p3: 71.0, p15: 73.0, p50: 75.7, p85: 78.1, p97: 80.5 },
  { month: 13, p3: 72.1, p15: 74.1, p50: 76.9, p85: 79.3, p97: 81.8 },
  { month: 14, p3: 73.1, p15: 75.1, p50: 78.0, p85: 80.5, p97: 83.0 },
  { month: 15, p3: 74.1, p15: 76.2, p50: 79.1, p85: 81.7, p97: 84.2 },
  { month: 16, p3: 75.0, p15: 77.1, p50: 80.2, p85: 82.8, p97: 85.4 },
  { month: 17, p3: 76.0, p15: 78.1, p50: 81.2, p85: 83.9, p97: 86.5 },
  { month: 18, p3: 76.9, p15: 79.1, p50: 82.3, p85: 85.0, p97: 87.7 },
  { month: 19, p3: 77.7, p15: 80.0, p50: 83.2, p85: 86.0, p97: 88.8 },
  { month: 20, p3: 78.6, p15: 80.9, p50: 84.2, p85: 87.0, p97: 89.8 },
  { month: 21, p3: 79.4, p15: 81.7, p50: 85.1, p85: 88.0, p97: 90.9 },
  { month: 22, p3: 80.2, p15: 82.5, p50: 86.0, p85: 89.0, p97: 91.9 },
  { month: 23, p3: 81.0, p15: 83.4, p50: 86.9, p85: 89.9, p97: 92.9 },
  { month: 24, p3: 81.7, p15: 84.1, p50: 87.8, p85: 90.9, p97: 93.9 },
];

// Length/Height-for-age (cm) - Girls
export const heightGirls: PercentileData[] = [
  { month: 0, p3: 45.4, p15: 47.1, p50: 49.1, p85: 51.0, p97: 52.9 },
  { month: 1, p3: 49.8, p15: 51.4, p50: 53.7, p85: 55.6, p97: 57.6 },
  { month: 2, p3: 53.0, p15: 54.7, p50: 57.1, p85: 59.1, p97: 61.1 },
  { month: 3, p3: 55.6, p15: 57.3, p50: 59.8, p85: 61.9, p97: 64.0 },
  { month: 4, p3: 57.8, p15: 59.5, p50: 62.1, p85: 64.3, p97: 66.4 },
  { month: 5, p3: 59.6, p15: 61.4, p50: 64.0, p85: 66.2, p97: 68.5 },
  { month: 6, p3: 61.2, p15: 63.0, p50: 65.7, p85: 68.0, p97: 70.3 },
  { month: 7, p3: 62.7, p15: 64.5, p50: 67.3, p85: 69.6, p97: 71.9 },
  { month: 8, p3: 64.0, p15: 65.9, p50: 68.7, p85: 71.1, p97: 73.5 },
  { month: 9, p3: 65.3, p15: 67.2, p50: 70.1, p85: 72.6, p97: 75.0 },
...
export function getPercentileData(
  ...
  if (metric === 'weight') {
    return gender === 'male' ? weightBoys : weightGirls;
  }
  return gender === 'male' ? heightBoys : heightGirls;
}
